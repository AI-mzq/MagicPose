...
train_cfg = dict(by_epoch=True, max_epochs=100, val_interval=33)
val_cfg = dict()
test_cfg = dict()
dataset_type = 'CocoDataset'
data_mode = 'topdown'
data_root = '/data/mzq/temp/pose_datasets/Ear210_Keypoint_Dataset_coco/'
dataset_info = dict(
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file=
        '/data/mzq/temp/pose_datasets/Ear210_Keypoint_Dataset_coco/val_coco.json'
    ),
